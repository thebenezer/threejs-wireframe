...
// Import shader files
import fragmentShader from "../lib/frag.js";
import vertexShader from "../lib/vert.js";
...
function setupGUI() {
	...
	const randomColors = () => {
		...
		// Update all controllers in lil-gui
		shader.controllersRecursive().forEach((controller) => {
